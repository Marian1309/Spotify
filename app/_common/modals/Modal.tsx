      ...
      <Dialog.Portal>
        <Dialog.Overlay className='bg-neutral-900/90 backdrop-blur-sm fixed inset-0 h-full'>
          <Dialog.Content
            ...
            max-h-full h-full md:h-auto md:max-h-full w-full md:w-[90vw] md:max-w-[450px]
          ...
          >
            ...
            <Dialog.Close
              asChild
              className='text-neutral-400 hover:text-white absolute top-[10px] right-[10px] cursor-pointer
